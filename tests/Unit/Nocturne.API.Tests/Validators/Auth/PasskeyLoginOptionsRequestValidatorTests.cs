...
public class PasskeyLoginOptionsRequestValidatorTests
{
    private readonly PasskeyLoginOptionsRequestValidator _validator = new();

    private static PasskeyLoginOptionsRequest ValidRequest() => new()
    {
        Username = "testuser",
    };
